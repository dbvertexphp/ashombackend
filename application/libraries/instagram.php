...
class Instagram_api {
    ...
    public function get_popular_media()
    {
    	...
    	$popular_media_request_url = 'https://api.instagram.com/v1/media/popular?client_id=' . $this->config->item('instagram_client_id');
        print_r($popular_media_request_url);die();
