    ...
    <div class="tab-content col-md-6">
        ...
        <tbody>
          <tr>
                ...
                <td></td>
                <td><input type="text" value="" placeholder="Enter exchange Name Here" name="exchange"></td>
                <td><input type="submit" class="btn btn-primary"  name="updateexchanges" value="Add" required></td>
                </form>
                </tr>
          <?php
          $i=0;
          $exchanges = $this->db->get("exchanges")->result();
          foreach ($exchanges as $value) {
            ...
            ?>
                ...
                <form action="" method="POST">
                <td><?=$i?></td>
                <td><input type="hidden" name="exchange_id" value="<?=$value->id?>"><input type="text" value="<?php echo $value->exchange; ?>" name="exchange"></td>
...
function deleteexchange(id){
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
         url: '<?php echo base_url("admin/deleteexchange/")?>'+id,
             type: 'POST',
             error: function() {
