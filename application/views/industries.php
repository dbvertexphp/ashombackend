    ...
    <div class="tab-content col-md-6">
        ...
        <tbody>
          <tr>
                ...
                <td></td>
                <td><input type="text" value="" placeholder="Enter Industry Name Here" name="industry"></td>
                <td><input type="submit" class="btn btn-primary"  name="updateindustries" value="Add" required></td>
                </form>
                </tr>
          <?php
          $i=0;
          $industries = $this->db->get("industries")->result();
          foreach ($industries as $value) {
            ...
            ?>
                ...
                <form action="" method="POST">
                <td><?=$i?></td>
                <td><input type="hidden" name="indus_id" value="<?=$value->id?>"><input type="text" value="<?php echo $value->industry; ?>" name="industry"></td>
                <td> <button  type="button" " onclick="deleteindustry(<?=$value->id?>)" style="color:red; background:none; border:none;" id="deleteaccess"><span class="glyphicon glyphicon-trash" for="deleteaccess"></span></button>
...
function deleteindustry(id){
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
         url: '<?php echo base_url("admin/deleteindustry/")?>'+id,
             type: 'POST',
             error: function() {
