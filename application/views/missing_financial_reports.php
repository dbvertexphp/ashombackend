    ...
    <div class="tab-content">
        <table id="example3">
                <thead>
                    <tr>
                      <th>Sr. No.</th>
                      <th data-toggle="all" style="text-align: center; width:50px" >Company Name</th>
                      <th data-toggle="all">Symbol /Ticker</th>
                      <th data-toggle="all">Country</th>
                     <th data-toggle="all"  >Years</th>
                       <th data-toggle="all">Periods</th>
                      <th data-toggle="all">Reports</th>
                       <th data-toggle="all">CF</th>
                       <th data-toggle="all">BS</th>
                       <th data-toggle="all">IS</th>
                       <th data-toggle="all">OCI</th>
                       <th data-toggle="all">CIE</th>
                       <th data-toggle="all">Notes</th>
                       <th data-toggle="all">Financial Report</th>
                     </tr>
                      </thead>
                    <tbody id="tableloads">
				     <?php
                      ...
                      <tr>
                        ...
                        <td><?=$document->CF?></td>
                        <td><?=$document->BS?></td>
                        <td><?=$document->IStmt?></td>
                        <td><?=$document->OCI?></td>
                        <td><?=$document->CIE?></td>
                        <td><?=$document->Notes?></td>
                        <td><?=$document->financial_report?></td>
                      </tr>  
                     <?php }
                     ?> 
            		</tbody>
